    ...
    <div class="wrap-login">
        ...
        <form class="login-form" action="log-session.php?login=true" method="post">
            ...
            <div class="wrap-inputLog">
                <input class="inputLog" type="email" name="userMail"
                 placeholder="Correo" required 
                 oninvalid="this.setCustomValidity('Ingresa tu correo para iniciar sesión')" 
            ...
            <div class="wrap-inputLog">
                ...
                oninvalid="this.setCustomValidity('Ingresa tu contraseña para iniciar sesión')" 
                oninput="this.setCustomValidity('')"> 
                <i class="fa fa-lock"></i>
            </div>
            <div class='showPassDiv'>
                <input type="checkbox" class="checkBx" 
                 id="showPass" name="showPass" value="1">
